...
<section class="woocommerce-order-downloads payment_details">

	<div class="head"><h2 class="title"><i class="icon icon-caret-left-blue"></i><?php _e( 'Your Downloads', 'bigikala' ) ?></h2></div>
		...
		<table>
			<thead>
				<tr>
					...
					<td class="<?php echo esc_attr( $column_id ); ?>><span class="nobr"><?php echo esc_html( $column_name ); ?></span></td>
					<?php endforeach; ?>
				</tr>
			</thead>
			<tbody>
