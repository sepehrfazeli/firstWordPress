...
! function( $ ) {
	...
	function USHeader( settings ) {
		...
		// Make sure that this.sticky_auto_hide is either true or false
	...
	$.extend( USHeader.prototype, {
		...
		scroll: function() {
			...
			if ( this.sticky_auto_hide && this.hasSticky() && !this.isScrollBoundaries( scrollTop ) ) {
				// Only when changing the position of the scroll, we determine the direction!
				if ( parseInt( prevScrollTop ) != parseInt( scrollTop ) ) {
