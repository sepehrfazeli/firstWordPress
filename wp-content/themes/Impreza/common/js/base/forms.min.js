jQuery(function($){$('.w-form.for_cform').each(function(){var $form=$(this),$submitBtn=$form.find('.w-btn'),$resultField=$form.find('.w-form-message'),options=$form.find('.w-form-json')[0].onclick(),$requiredCheckboxes=$form.find('.for_checkboxes.required');$form.find('.w-form-json').remove();$form.submit(function(event){event.preventDefault();if($submitBtn.hasClass('loading')){return}
